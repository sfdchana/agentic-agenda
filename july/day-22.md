...
Where does axis-scoring sit on cost/latency/quality? When would a smaller model be the right call here?

## 3 flashcard ideas
- what does prompt caching cache?
- the cost/latency/quality triangle?
- funnel + judge-once — why both?

_Journal: the real per-item cost of scoring the archive._
